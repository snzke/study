 ...
 * 
 */
@WebService(name = "BusinessService", targetNamespace = "http://webservice.snzke.org/client", wsdlLocation = "http://127.0.0.1:7200/BusinessService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName BUSINESSSERVICE_QNAME = new QName("http://webservice.snzke.org/client", "BusinessService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://127.0.0.1:7200/BusinessService?wsdl");
    ...
    public Business getBusinessPort() {
        return super.getPort(new QName("http://webservice.snzke.org/client", "BusinessPort"), Business.class);
    }
    ...
    public Business getBusinessPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice.snzke.org/client", "BusinessPort"), Business.class, features);
    }
